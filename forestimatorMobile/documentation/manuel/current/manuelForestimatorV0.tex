...
\author{Thierry Thissen, Jonathan Lisein et Mistral AI}
\date{\today}
...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\Large Rédaction : Thierry Thissen, Jonathan Lisein et Mistral AI\par}
    \vspace{2cm}
...
Il existe une version web et une application mobile de Forestimator. Ce manuel est dédié à l'application mobile, disponible sur Android et iOS.
...
\section{Avant d'utiliser le mode hors ligne}
\begin{itemize}
