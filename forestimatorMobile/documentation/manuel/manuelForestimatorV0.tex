...
\begin{itemize}
	...
	\item \textbf{Contact :} Adresse du site web principal et l'adresse email pour poser des questions ou signaler des bugs.
...
\begin{instructionbox}{Modifier les options d'une couche}
	\begin{enumerate}
		\item En appuyant sur l'encart d'une couche, vous avez accès à la description complète et vous pouvez modifier certaines propriétés : sélectionner la couche pour les analyses ponctuelles et surfacique, ou encore effectuer son téléchargement pour un usage en \gls{offline}.
	\end{enumerate}
\end{instructionbox}
