...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.35\textwidth]{PolygonMenu1.png}
	\caption{Menu des points et polygones. A gauche la vue globale listant les différentes \gls{layers}, à droite la vue compacte avec les outils permettant d'ajouter ou de modifier des entités pour une \gls{layers}. Utilisez les boutons \includegraphics[width=0.05\textwidth]{icons/hexagon.png} ou \includegraphics[width=0.05\textwidth]{icons/reduire.png} pour passer de la vue globale à la vue compacte.}
\end{figure}
...
\begin{instructionbox}{Créer un nouveau polygone}
	\begin{enumerate}
		...
		\item Un nouvel élément apparaît en haut de la liste des couches cartographiques de polygone. Les informations relative au polygone y sont affichées : le nom, sa surface et son périmètre.
...
\begin{instructionbox}{Ajouter des sommets/vertex}
	\begin{enumerate}
		...
		\item Pour changer le segment de droite à modifier, vous pouvez appuyer sur un autre sommet.
	\end{enumerate}
\end{instructionbox}
