...
import '/locationIndicator/src/animation/latlng_tween.dart';

typedef LocationAnimationUpdate = void Function(
...
class LocationIndicatorWrapper extends ImplicitlyAnimatedWidget {
  ...
  @override
  AnimatedWidgetBaseState<LocationIndicatorWrapper> createState() =>
      _LocationIndicatorWrapperState();
}

class _LocationIndicatorWrapperState
    extends AnimatedWidgetBaseState<LocationIndicatorWrapper> {
  ...
  LatLng get _position =>
      _positionTween?.evaluate(animation) ?? _positionTween!.begin!;

  @override
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _positionTween = visitor(_positionTween, widget.position,
        (value) => LatLngTween(begin: value)) as LatLngTween;
  }
