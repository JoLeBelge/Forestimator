...
class AccuracyIndicatorWrapper extends ImplicitlyAnimatedWidget {
  ...
  @override
  AnimatedWidgetBaseState<AccuracyIndicatorWrapper> createState() =>
      _AccuracyIndicatorWrapperState();
}

class _AccuracyIndicatorWrapperState
    extends AnimatedWidgetBaseState<AccuracyIndicatorWrapper> {
  Tween<double>? _sizeTween;

  double get _accuracy =>
      _sizeTween?.evaluate(animation) ?? _sizeTween?.begin ?? 0;

  @override
  void forEachTween(TweenVisitor<dynamic> visitor) {
    _sizeTween = visitor(
            _sizeTween, widget.radius, (value) => Tween<double>(begin: value))
        as Tween<double>;
  }
